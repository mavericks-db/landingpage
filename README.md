...
## Website Mockup 📱 💻 🖥️
![all-devices-black](https://user-images.githubusercontent.com/98527559/166160449-eefc9dce-d2d2-4b64-b0a7-f63e2beceb8d.png)
...
Check the live demo [here](https://mavericks-db.github.io/landingpage/)👈
...
```
$ git clone git@github.com:mavericks-db/landingpage.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/landingpage/issues).
